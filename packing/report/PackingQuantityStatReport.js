...
import PackingQuantityStatReportTable from './PackingQuantityStatReportTable';

export default class PackingQuantityStatReport extends Component {
    ...
    constructor(props) {
        ...
        this.PackingQuantityStatReportTableComponent = React.createRef();
    ...
    componentDidMount() {
        ...
        if (parsed.packing_date) {
            ...
            }, this.queryPackingQuantityStatReport);
    ...
    //查詢包裝報表
    queryPackingQuantityStatReport = () => {
        this.setState({ isLoading: true });

        const apiUrl = Utils.generateApiUrl('/packing/getPackingQuantityStatReport');
        const apiData = {
    ...
    exportReport = () => {
        ...
        exportDataToXlsx([
            {
                sheetName: '包裝量統計表',
                columns: this.PackingQuantityStatReportTableComponent.current.state.columns,
                colHeaders: this.PackingQuantityStatReportTableComponent.current.state.colHeaders,
                data: this.state.statReport,
                hotTableComponent: this.PackingQuantityStatReportTableComponent.current.hotTableComponent,
                mergeCells: true,
            },
        ], 'PBTC包裝量統計表.xlsx');
    }
        ...
        return <div className="packing-stat-report">
            <div className="packing-query-container mb-2">
                ...
                <button type="button"
                    ...
                    onClick={this.queryPackingQuantityStatReport} disabled={isLoading}><span className="icon bi-search"></span> 查詢</button>
            ...
            <div className="packing-handsontable-container flex-grow-1">
                <PackingQuantityStatReportTable
                    ref={this.PackingQuantityStatReportTableComponent}
...
PackingQuantityStatReport.propTypes = {
...
PackingQuantityStatReport.defaultProps = {
    isAdmin: false,
    lines: [],
    materials: [],
    notes: [],
